...
typedef struct EvalAndLoadSetup {
    ...
    bool linearizedResidualLoadOnlyIfLimited {};
    ...
    // For loading limited and linearized part of reactive flow residual
    IntegratorCoeffs* integCoeffs {};
    bool storeTerminalReactiveResidualState {};
    bool storeTerminalReactiveResidualDerivativeState {};
    ...
    // Negative initially, set first by an instance that calls $discontinuity with 
...
public:
    ...
    virtual std::tuple<bool, bool, bool> setup(Circuit& cir, bool force, Status& s=Status::ignore) { return std::make_tuple(true, false, false); };
