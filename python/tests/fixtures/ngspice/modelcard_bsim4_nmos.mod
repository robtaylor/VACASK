...
* https://github.com/dwarning/VA-Models/blob/main/examples/bsim4/Modelcards/modelcard.nmos
*
* Note: This model card was not extracted from any real technology.
* It should not be used except for benchmarking BSIM4 implementation.

.model n1 nmos level=54 version=4.80
