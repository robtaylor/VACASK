...
First, read the section on [using Xschem with VACASK](../xschem/README.md). The included converter patches all symbols provided by the PDK in the `ihp-sg13g2/libs.tech/xschem/sg13g2_pr` directory so that they can be used for creating VACASK netlists. 
